...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('policies', function (Blueprint $table) {
            ...
            $table->jsonb('allowed_addresses')->nullable();    // whitelist of 'to' addresses
            $table->jsonb('allowed_contracts')->nullable();   // contract addresses allowed
            $table->jsonb('blocked_selectors')->nullable();   // 4-byte selectors blocked
            $table->jsonb('require_approval_selectors')->nullable();
            ...
            $table->jsonb('schedule')->nullable();        // { days: [], hours: [] }
