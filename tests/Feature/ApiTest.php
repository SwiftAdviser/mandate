...
class ApiTest extends TestCase
{
    ...
    {
        $response = $this->postJson('/api/validate/raw', $this->buildPayload());
    ...
    public function test_validate_rejects_invalid_key(): void
    {
        ...
        ])->postJson('/api/validate/raw', $this->buildPayload());
    ...
    public function test_validate_duplicate_intent_hash_returns_existing(): void
    {
        ...
        $first = $this->withHeaders($headers)->postJson('/api/validate/raw', $payload);
        $second = $this->withHeaders($headers)->postJson('/api/validate/raw', $payload);
    ...
    public function test_post_event_transitions_to_broadcasted(): void
    {
        ...
        $validateResponse = $this->withHeaders($headers)->postJson('/api/validate/raw', $this->buildPayload());
